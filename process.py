...
def graph(train_proj, train_set_labels):
    colours = ['black', 'grey', 'red', 'lightcoral', 'darkorange', 'tan', 'gold', 'darkkhaki', 'darkgreen', 'lime', 'cyan', 'blue', 'darkblue', 'slateblue', 'indigo', 'thistle', 'fuchsia', 'pink']
    fig = plt.figure()
...
def main():
    ...
    if args.mode:
        ...
        #for i in range(50):
        #    knn(train_set, train_set_labels, validation_set, validation_set_labels, i+1)
        knn(train_set, train_set_labels, validation_set, validation_set_labels, 45)
